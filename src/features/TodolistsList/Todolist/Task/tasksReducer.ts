...
export const deleteTask = createAppAsyncThunk<deleteTaskType, deleteTaskType>(
  'tasks/deleteTask',
...
export const createTask = createAppAsyncThunk<{ task: TaskType }, { todolistId: string; title: string }>(
  'tasks/createTask',
  async (arg, { dispatch, rejectWithValue }) => {
    try {
...
export const updateTask = createAppAsyncThunk<updateTaskType, updateTaskType>(
  'tasks/updateTask',
